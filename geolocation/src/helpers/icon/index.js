...
const groupMarker = () => (`<svg width="26" height="32" viewBox="0 0 26 32" fill="none" xmlns="http://www.w3.org/2000/svg"><mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="0" y="8" width="16" height="24"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 8C3.57714 8 0 11.756 0 16.4C0 22.7 8 32 8 32C8 32 16 22.7 16 16.4C16 11.756 12.4229 8 8 8Z" fill="#EB5757"/></mask><g mask="url(#mask0)"><path d="M-2 7C-2 5.89543 -1.10457 5 0 5H8V16H-2V7Z" fill="#5F2D9F"/><path d="M8 4H19C20.1046 4 21 4.89543 21 6V16H8V4Z" fill="#1F7AAD"/><path d="M0 16H8V36H0V16Z" fill="#2D9F4D"/><path d="M8 16H20V34C20 35.1046 19.1046 36 18 36H8V16Z" fill="#9F2D78"/><path d="M8 18C9.10457 18 10 17.1046 10 16C10 14.8954 9.10457 14 8 14C6.89543 14 6 14.8954 6 16C6 17.1046 6.89543 18 8 18Z" fill="white"/></g></svg>`);
const groupMarkerHover = () => (`<svg width="29" height="37" viewBox="0 0 29 37" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0)"><mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="0" y="6" width="20" height="31"><path fill-rule="evenodd" clip-rule="evenodd" d="M10 6C4.47143 6 0 10.8515 0 16.85C0 24.9875 10 37 10 37C10 37 20 24.9875 20 16.85C20 10.8515 15.5286 6 10 6Z" fill="#EB5757"/></mask><g mask="url(#mask0)"><path d="M-2 5C-2 3.89543 -1.10457 3 5.96046e-08 3H10V18H-2V5Z" fill="#5F2D9F"/><path d="M10 2H23C24.1046 2 25 2.89543 25 4V18H10V2Z" fill="#1F7AAD"/><path d="M0 15H10V39H0V15Z" fill="#2D9F4D"/><path d="M10 15H24V37C24 38.1046 23.1046 39 22 39H10V15Z" fill="#9F2D78"/><rect x="7.5" y="12.66" width="5" height="5" rx="2.5" fill="white"/></g></g><defs><clipPath id="clip0"><rect width="29" height="37" fill="white"/></clipPath></defs></svg>`);
...
export const iconMarker = (iconName: IconName, color: string) => {
	...
	const iconData = {
		iconUrl: url,
		iconRetinaUrl: url,
		className: `${iconName} customMarker ${active}`
	};
