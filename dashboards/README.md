...
* для поддержания производительности на должном уровне максимально возможное количество виджетов на одном дашборде ограничено 30ю; 
* реализован функционал задания пользователем интервала времен автоматического обновления информации во всех виджетах дашборда; 
