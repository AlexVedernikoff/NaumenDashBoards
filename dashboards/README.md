...
## 3.3.0
- Добавлена функция вывода топ для минимальных значений
- Для виджета сводная таблица реализована настройка отображения сворачивания групп
- Добавлена возможность настраивать формат ля временного интервала при построении по этому атрибуту
- Добавлена навигация на панели редактирования улучшающая взаимодействие с приложением.
- Откорректирована работа drillDown с шаблонами списков, с функцией отображения незаполненных данных, а также для виджетов ов которые построены с использованием динамических атрибутов.
- Откорректирована работа тултипа и промежуточных результатов в случае вывода агрегации %.
- Оптимизирован поиск объектов внутри приложения при построении кастомной группировки.

## 3.2.0
- Позиционирование уведомлений
- Отображение атрибута с типом дата
- Добавление возможности использовать в форме фильтрации ссылочных атрибутов
- Доработка пользовательской фильтрации. Закрытие формы при необходимости
- Доработка подписи столбцов
- Сводная таблица: функция суммы
- Сводная таблица: экспорт в XLS
- Изменение дефолтной цветовой палитры
- Исправлена ошибка наложения значений Итого и Легенда друг на друга
- Поправлен дриллдаун при построении виджета типа диаграммы Таблица, когда в условиях фильтрации есть атрибут типа Ссылка на бизнес-объект
- Для пользовательской группировки добавлен поиск по атрибуту Статус
- Исправлена ошибка построения диаграммы типа Таблица при вычислимом поле в Показателе и включенной функции “Отображать общую сумму объектов”
- Исправлена ошибка отображения подсказки в показателе в сводной таблице
- Исправлена ошибка ошибка при настройке пользовательской группировки
- Исправлена ошибка изменения размера шрифта Легенды
- Исправлена ошибка при настройке системной группировки формирования - 7 дней на ссылочный атрибут
- Исправлена ошибка построения, если используется пользовательская группировка для разбивки
- Исправлена ошибка растяжение панели редактирования на весь контент, при добавлении контента и нажатии на правую кнопку мыши внизу контента
- Исправлена ошибка построения диаграммы типа: таблица сводная таблица
- Исправлена ошибка в пользовательских группировках
- Исправлена ошибка не работающей навигации (ITSM 365)
- Исправлена ошибка объединения агрегации cnt % (ITSM)
- Исправлена ошибка различных значения "итого" при одинаковых настройках источников
- Исправлена ошибка при обновлении на 3.1.0 (с 3.0.2 и 2.4.26)
- Исправлена ошибка обновлении на 3.1.2
- Исправлена ошибка зависание дашбордов при редактировании
- Исправлена ошибки при переходе в редактирование виджета - исчезает (сереет) весь дашборд
- Исправлена ошибка при первом создании сводки
- Исправлена ошибка при работе сводной таблицы с некоторыми классами
- Исправлена ошибка отображение подписей - промежуточных итогов
- Исправлено некорректное отображение подписей в таблице для агрегации cnt(%) на пользовательском дашборде

### 3.1.0
- Разработан новый тип виджета Сводная таблица
- Переход на 3-х значного формат SemVer 2.0
- Исправлена ошибка ДД в таблице без параметра в пользовательском режиме
- Исправлена ошибка порядка элементов разбивки при построении таблицы без параметра
- Исправлено несоответствие кол-ва запросов в пользовательском режиме
- Исправлена ошибка построения диаграмма типа "Таблица" при выборе в Разбивке

### 3.0.1
 - Увеличено качество экспорта в PDF
 - Доработка всплывающей подсказки на виджете
 - Исправлена ошибка неверного отображения легенды
 - Исправлена излишняя валидация при построении с вычислимым источником
 - Исправлена ошибка построения виджета  с параметром типа Вещественное число/Целое число/Строка
 - Исправлена ошибка неточного расчета процента при разбивке
 - Исправлена ошибка группировки по ссылочному атрибуту
 - Отключение агрегации CNT (%) для сводки и спидометра
 - Исправлено наложение подписей гистограмм на легенду
 - Доработано отображение значений атрибута Временный интервал
 - Исправлено переключение режимов отображения в пользовательском режиме
 - Стабилизация методов первоначальной настройки дашбордов

### 3.0.0
* Переход на библиотеку recharts
* Изменения в формировании сборки: два варианта файла parameters.xml в зависимости от режима запуска
* Изменение функционала промежуточных итогов в новой библиотеке
* Доработаны тултипы для показателя в формате "абсолютный показатель (процент)"
* Доработка таблицы. При построении без параметра добавлена возможность указывать разные атрибуты разбивки с одним типом.

#### Исправление ошибок
* При построении комбо диаграммы, невозможно для показателей выставить один и тот же атрибут
* Ошибка валидации при одинаковых атрибутах разбивки
* Экранирование символов при выгрузке XLSX
* Построение таблицы без параметра: при нажатии на сумму, виджет ломается.
* Масштаб в браузере влияет на видимость легенды в диаграмме
* Проблема загрузки списка доступных значений при настройке виджета
* Долгое формирование списка объектов на отдельной странице
* Обрезается название оси показателя
* В ряде случаев не сохранялся пользовательский фильтр
* Не считается общая сумма объектов в виджите типа Линейная диаграмма
* Обрезается формат файла на форме для отправки почты при выборе PNG
* В диаграмме типа "Таблица" при выборе "Показать пустую строку" в ячейках с отсутствующими данными, отображается "-"
* Пропала возможность выбора нескольких податрибутов ссылочного атрибута в параметрах таблицы
