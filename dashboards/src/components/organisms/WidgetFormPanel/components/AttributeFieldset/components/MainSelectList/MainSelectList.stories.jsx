...
import {props} from 'WidgetFormPanel/components/AttributeFieldset/components/AttributeSelect/AttributeSelect.stories';
import React from 'react';
import {useArgs} from '@storybook/client-api';

export default {
	component: MainSelectList,
	title: 'Organisms/WidgetFormPanel/Components/AttributeFieldset/Components/MainSelectList'
};
