...
export const withAttributeFieldset = <Config: {} & Context>(
	Component: React$ComponentType<Config>
): React$ComponentType<Config> =>
		class WithAttributeFieldset extends React.Component<Config> {
			renderComponent = (context: Context) => <Component {...this.props} {...context} />;
