...
sprite.add(ICON_NAMES.ARROW_FULL_DOWN, `
	<path d="M11.29 7.83C11.68 7.44 12.32 7.44 12.71 7.83C13.1 8.23 13.1 8.87 12.71 9.26L8 14L3.29 9.26C2.9 8.87 2.9 8.23 3.29 7.83C3.68 7.44 4.32 7.44 4.71 7.83L7 10.14L7 3C7 2.45 7.45 2 8 2C8.55 2 9 2.45 9 3L9 10.14L11.29 7.83Z" />
`);

sprite.add(ICON_NAMES.ARROW_FULL_LEFT, `
	<path d="M8.17 11.29C8.56 11.68 8.56 12.32 8.17 12.71C7.77 13.1 7.13 13.1 6.74 12.71L2 8L6.74 3.29C7.13 2.9 7.77 2.9 8.17 3.29C8.56 3.68 8.56 4.32 8.17 4.7L5.86 7L13 7C13.55 7 14 7.45 14 8C14 8.55 13.55 9 13 9L5.86 9L8.17 11.29Z"/>
`);

sprite.add(ICON_NAMES.ARROW_FULL_RIGHT, `
	<path d="M7.83 11.29C7.44 11.68 7.44 12.32 7.83 12.71C8.23 13.1 8.87 13.1 9.26 12.71L14 8L9.26 3.29C8.87 2.9 8.23 2.9 7.83 3.29C7.44 3.68 7.44 4.32 7.83 4.71L10.14 7L3 7C2.45 7 2 7.45 2 8C2 8.55 2.45 9 3 9L10.14 9L7.83 11.29Z" />
`);

sprite.add(ICON_NAMES.ARROW_FULL_UP, `
	<path d="M4.71 8.17C4.32 8.56 3.68 8.56 3.29 8.17C2.9 7.77 2.9 7.13 3.29 6.74L8 2L12.71 6.74C13.1 7.13 13.1 7.77 12.71 8.17C12.32 8.56 11.68 8.56 11.29 8.17L9 5.86L9 13C9 13.55 8.55 14 8 14C7.45 14 7 13.55 7 13L7 5.86L4.71 8.17Z"/>
`);
...
sprite.add(ICON_NAMES.BREAKDOWN, `
	<path d="M2.46,3.54H13.48c0.55,0 1,0.45 1,1v2.5c0,0.55 -0.45,1 -1,1H 2.46c-0.55,0 -1,-0.45 -1,-1V4.55c0,-0.55 0.45,-1 1,-1z" />
	<path d="m2.46,8.93h1.69c0.55,0 1,0.45 1,1v1.52c0,0.55 -0.45,1 -1,1H2.46c-0.55,0 -1,-0.45 -1,-1V10c0,-0.55 0.45,-1 1,-1z" />
	<path d="M7.13,8.93H8.82c0.55,0 1,0.45 1,1v1.52c0,0.55 -0.45,1 -1,1H7.13c-0.55,0 -1,-0.45 -1,-1V10c0,-0.55 0.45,-1 1,-1z" />
	<path d="m11.8,8.93h1.69c0.55,0 1,0.45 1,1v1.52c0,0.55 -0.45,1 -1,1h-1.69c-0.55,0 -1,-0.45 -1,-1V10c0,-0.55 0.45,-1 1,-1z" />
`);
...
sprite.add(ICON_NAMES.CONNECTION, `
	<path d="M9 11C9 10.45 9.45 10 10 10L10 12C9.45 12 9 11.55 9 11ZM10 12H11C11.67 12 12.64 11.79 13.46 11.19C14.34 10.55 15 9.51 15 8C15 6.5 14.34 5.45 13.46 4.81C12.64 4.2 11.67 4 11 4L10 4C9.45 4 9 4.45 9 5C9 5.55 9.45 6 10 6L11 6C11.33 6 11.86 6.12 12.29 6.43C12.66 6.7 13 7.16 13 8C13 8.84 12.66 9.3 12.29 9.57C11.86 9.88 11.33 10 11 10H10L10 12Z" />
	<path d="M7 5C7 5.55 6.55 6 6 6L6 4C6.55 4 7 4.45 7 5ZM6 4L5 4C4.34 4 3.38 4.18 2.54 4.78C1.66 5.42 1 6.47 1 8C1 9.53 1.66 10.58 2.54 11.219C3.38 11.82 4.34 12 5 12H6C6.55 12 7 11.55 7 11C7 10.45 6.55 10 6 10H5C4.66 10 4.12 9.9 3.7 9.59C3.34 9.33 3 8.88 3 8C3 7.121 3.34 6.67 3.7 6.41C4.12 6.11 4.66 6 5 6L6 6L6 4Z" />
	<path d="M5 8C5 7.45 5.45 7 6 7H10C10.55 7 11 7.45 11 8C11 8.55 10.55 9 10 9H6C5.45 9 5 8.55 5 8Z" />
`);
...
sprite.add(ICON_NAMES.PIVOT_TABLE, `
	<path d="M3 5h3v3H3v-3Zm4 4h4v3H7v-3Z"/>
	<path d="M3 9h3v10H3v-10Z" fill="${WIDGET_SUB_COLOR}"/>
	<path d="M21 5 21 8 7 8 7 5 21 5Z" fill="${WIDGET_SUB_COLOR}"/>
	<path d="m18 9 1.73 3h-3.5l1.73-3ZM8 17l3-1.73v3.5L8 17Z"/>
	<path d="M18.5 12v5.5h-1V12h1Z"/>
	<path d="M11 16.5h7v1h-7v-1Z"/>
`);
...
sprite.add(ICON_NAMES.SIDEBAR_ROUND_LEFT, `
	<path d="M12 6C13.1 6 14 6.9 14 8C14 9.1 13.1 10 12 10C10.9 10 10 9.1 10 8C10 6.9 10.9 6 12 6Z"/>
	<path d="M2.4 8.8L6.49 11.81C7.12 12.28 8 11.81 8 11.01V4.99C8 4.19 7.12 3.72 6.49 4.18L2.4 7.2C1.87 7.59 1.87 8.41 2.4 8.8Z"/>
`);

sprite.add(ICON_NAMES.SIDEBAR_ROUND_RIGHT, `
	<path d="M4 6.06C2.9 6.06 2 6.95 2 8.06C2 9.16 2.9 10.06 4 10.06C5.1 10.06 6 9.16 6 8.06C6 6.95 5.1 6.06 4 6.06Z"/>
	<path d="M13.58 8.87L9.6 11.93C8.93 12.4 8 11.93 8 11.12V5C8 4.19 8.93 3.72 9.6 4.19L13.58 7.24C14.14 7.64 14.14 8.47 13.58 8.87Z"/>
`);

sprite.add(ICON_NAMES.SIDEBAR_ROUND_DOWN, `
	<path d="M6 4.06C6 2.95 6.9 2.06 8 2.06C9.1 2.06 10 2.95 10 4.06C10 5.16 9.1 6.06 8 6.06C6.9 6.06 6 5.16 6 4.06Z"/>
	<path d="M8.81 13.63L11.87 9.662C12.34 8.99 11.87 8.06 11.06 8.06H4.94C4.13 8.06 3.66 8.99 4.13 9.662L7.19 13.63C7.59 14.2 8.41 14.2 8.81 13.63Z"/>
`);

sprite.add(ICON_NAMES.SIDEBAR_ROUND_UP, `
	<path d="M6 12.06C6 13.16 6.9 14.06 8 14.06C9.1 14.06 10 13.16 10 12.06C10 10.954 9.1 10.06 8 10.06C6.9 10.06 6 10.954 6 12.06Z"/>
	<path d="M8.81 2.48L11.87 6.45C12.34 7.13 11.87 8.06 11.06 8.06H4.94C4.13 8.06 3.66 7.13 4.13 6.45L7.19 2.48C7.59 1.92 8.41 1.92 8.81 2.48Z"/>
`);
...
sprite.add(ICON_NAMES.ROW_COLOR, `
	<path d="M0 2C0 0.9 0.9 0 2 0H48C49.1046 0 50 0.91 50 2V32C50 33.1046 49.1046 34 48 34H2C0.92 34 0 33.1046 0 32V2Z" fill="white"/>
	<rect height="6" width="26" x="12" y="8"/>
	<path d="M34 16H12V20H34V16Z" fill="#E6E6E6"/>
	<path d="M34 22H12V26H34V22Z" fill="#E6E6E6"/>
	<path d="M2 1H48V-1H2V1ZM49 2V32H51V2H49ZM48 33H2V35H48V33ZM1 32V2H-1V32H1ZM2 33C1.45 33 1 32.55 1 32H-1C-1 33.66 0.34 35 2 35V33ZM49 32C49 32.55 48.55 33 48 33V35C49.66 35 51 33.66 51 32H49ZM48 1C48.55 1 49 1.45 49 2H51C51 0.343145 49.66 -1 48 -1V1ZM2 -1C0.34 -1 -1 0.34 -1 2H1C1 1.45 1.45 1 2 1V-1Z" fill="#E6E6E6"/>
`);
