...
type InfoPanel = 'InfoPanel::onConfirm' | 'InfoPanel::Attention';

// components/atoms/SearchInput
type SearchInput = 'SearchInput::Placeholder';

// components/atoms/TextArea
type TextArea = 'TextArea::Placeholder' | 'TextArea::Clear';

// components/molecules/Chart
type Chart = 'Chart::CountTotals';

// components/molecules/ColorPicker
type ColorPicker = 'ColorPicker::Apply' | 'ColorPicker::Cancel';
...
type MiniSelect = 'MiniSelect::NoSelect';

// components/molecules/Modal
type Modal = 'Modal::Cancel' | 'Modal::Save';

// components/molecules/MultiDropDownList
type MultiDropDownList = 'MultiDropDownList::EmptyMessage';
...
type TreeSelect = 'TreeSelect::DefaultPlaceholder';

// components/molecules/TreeSelect/components/Node
type TreeSelectNode = 'TreeSelectNode::ShowMore';
...
type SourceControl = 'SourceControl::Aggregation';
...
type AxisSettingsBox = 'AxisSettingsBox::Axis' | 'AxisSettingsBox::AxisName';
...
type ComboChartParamsTab = 'ComboChartParamsTab::GraphType';

// components/organisms/ComboChartWidgetForm/components/StyleTab
type ComboChartStyleTab = 'ComboChartStyleTab::Parameter';
...
type AndCondition = 'AndCondition::And';
...
type OrConditionControl = 'OrConditionControl::OR';

// components/organisms/GroupModal/components/SubGroup
type SubGroup = 'SubGroup::GroupLabel' | 'SubGroup::GroupName';

// components/organisms/GroupModal/components/SubGroupSection
type SubGroupSection = 'SubGroupSection::AddGroup';

// components/organisms/GroupModal/components/SystemDateGroupFormat
type SystemDateGroupFormat = 'SystemDateGroupFormat::ChoiceValue';

// components/organisms/GroupModal/components/SystemGroup
type SystemGroup = 'SystemGroup::Format';
...
type BorderStyleBox = 'BorderStyleBox::ScaleLimitsSignature';

// components/organisms/SpeedometerWidgetForm/components/RangeField
type BorderRangeField = 'BorderRangeField::Delete';
...
type Table = 'Table::Loading' | 'Table::EmptyData';
...
type TableTotal = 'Table::Total::Total';
...
type WidgetKebab = 'WidgetKebab::Edit' | 'WidgetKebab::Delete';

// components/organisms/WidgetAddPanel
type WidgetAddPanel =
  | 'WidgetAddPanel::AddText'
  | 'WidgetAddPanel::AddWidget'
  | 'WidgetAddPanel::OrChoiceVariant'
  | 'WidgetAddPanel::NoFullCopy'
  | 'WidgetAddPanel::NoReferenceAndUserGroupCopy'
  | 'WidgetAddPanel::NoReferenceCopy'
  | 'WidgetAddPanel::NoUserGroupCopy'
  | 'WidgetAddPanel::Confirm'
  | 'WidgetAddPanel::Create';

// components/organisms/WidgetFormPanel
type WidgetFormPanel = 'WidgetFormPanel::FormError';

// components/organisms/WidgetFormPanel/components/AttributeAggregationField
type AttributeAggregationField = 'AttributeAggregationField::Aggregation';

// components/organisms/WidgetFormPanel/components/AttributeFieldset/components/AttributeSelect
type AttributeSelect = 'AttributeSelect::Empty';
...
type AttributeGroupField = 'AttributeGroupField::Group';

// components/organisms/WidgetFormPanel/components/BreakdownFieldset
type BreakdownFieldset = 'BreakdownFieldset::Breakdown';

// components/organisms/WidgetFormPanel/components/BreakdownFormat
type BreakdownFormat = 'BreakdownFormat::Breakdown';
...
type CustomColorsSettings = 'CustomColorsSettings::ApplyForAllWidgets';
...
type ComputedAttributeEditor = 'ComputedAttributeEditor::EditField';
...
type DataTopField = 'DataTopField::ShowTop';
...
type FiltersOnWidget = 'FiltersOnWidget::FilterOnWidget';
...
type ParametersDataBox = 'ParametersDataBox::Parameter';
...
type SourceBox = 'SourceBox::Title';
...
// store/widgets/links
type StoreWidgetsLinks = 'store::widgets::links::DataLimit';

// utils/chart
type Axios = 'axios::Locales';

// utils/chart/methods
type DrillDownBySelection = 'drillDownBySelection::Fail';
