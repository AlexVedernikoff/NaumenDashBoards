...
sprite.add(ICON_NAMES.DOWNLOAD, `
	<path d="M11 5H8.96V8C8.9 8.5 8.5 9 7.9 9C7.4 9 6.9 8.5 6.9 8L6.9 5H4.96L7.9 1L11 5Z"/>
	<path d="M1.8 8.6C1.9 8.2 2.2 8 2.6 8H3.9C4.5 8 4.9 8.4 4.9 9C4.9 9.5 5.4 10 5.9 10H9.9C10.5 10 11 9.5 11 9C11 8.4 11.4 8 12 8H13.3C13.7 8 14.0 8.2 14 8.6L14.8 12.8C14.9 13.4 14.4 14 13.8 14H2.1C1.5 14 1.0 13.4 1.1 12.8L1.8 8.6Z"/>
`);
...
sprite.add(ICON_NAMES.CLEAR, `
	<path d="M13.4 1.1C12.7 0.5 11.72 0.5 11 1L7.7 4.1L10 6.32L13.3 3.2C14.1 2.6 14 1.7 13.4 1Z"/>
	<path d="M7.1 14C7.02 13.9 6.9 14 6.9 14L5.37 14C5.21 14 5.1 13.8 5.2 13.7L7 11L4.1 12.9C4 13 4 13 4 13L2 11C2 11 2 11 2 11L2 9C2 9 2 9 1.8 9H0.2C0.1 9 -1 9 0 8.84L1.7 7.11C1.83 7 0.03 6.9 0.1 6.9L5.3 4C5.6 3.8 6 3.9 6.3 4.2L10.1 7.7C10 8 10.4 8.4 10.2 8.7L7 13.9Z"/>
`);
