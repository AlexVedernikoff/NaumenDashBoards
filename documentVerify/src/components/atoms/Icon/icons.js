...
sprite.add(ICON_NAMES.TOGGLE_COLLAPSED, `
	<path fill-rule="evenodd" clip-rule="evenodd" d="M14 1H2C1.45 1 1 1.45 1 2V14C1 14.55 1.45 15 2 15H14C14.55 15 15 14.55 15 14V2C15 1.45 14.55 1 14 1ZM2 0C0.90 0 0 0.90 0 2V14C0 15.10 0.90 16 2 16H14C15.10 16 16 15.10 16 14V2C16 0.90 15.10 0 14 0H2Z" />
...
sprite.add(ICON_NAMES.TOGGLE_EXPANDED, `
	<path fill-rule="evenodd" clip-rule="evenodd" d="M14 1H2C1.45 1 1 1.45 1 2V14C1 14.55 1.45 15 2 15H14C14.55 15 15 14.55 15 14V2C15 1.45 14.55 1 14 1ZM2 0C0.90 0 0 0.90 0 2V14C0 15.1046 0.90 16 2 16H14C15.10 16 16 15.10 16 14V2C16 0.90 15.10 0 14 0H2Z" />
