...
const PanelIcon = ({color}: {color: string}) => (
	<svg width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<path fillRule="evenodd" clipRule="evenodd" d="M20 19C20 18.4477 20.4477 18 21 18H28V30H21C20.4477 30 20 29.5523 20 29V19ZM22 21H26V22H22V21ZM26 23H22V24H26V23ZM22 25H26V26H22V25Z" fill="#5F5F5F"/>
		<path d="M32 19C32 18.4477 31.5523 18 31 18H29V30H31C31.5523 30 32 29.5523 32 29V19Z" fill="#5F5F5F"/>
		<defs>
